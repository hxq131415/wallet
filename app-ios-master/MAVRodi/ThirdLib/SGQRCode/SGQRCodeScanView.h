...
/** 扫描内容的 W 值 */
#define scanBorderW 0.6 * self.frame.size.width
/** 扫描内容的 x 值 */
#define scanBorderX 0.5 * (1 - 0.6) * self.frame.size.width
/** 扫描内容的 Y 值 */
#define scanBorderY 0.5 * (self.frame.size.height - scanBorderW) - TE_NavigationBar_Height
